...
namespace GocartSetupTracker.Models {
    public class CartSetup {
        ...
        public bool IsWithFrontbar { get; set; }
        ...
        public List<CartSetupPropertyData> GetCartSetupProperties() {
            ...
            List<CartSetupPropertyData> propertiesWithName = new List<CartSetupPropertyData>() {
                ...
                new CartSetupPropertyData("Dæktryk venstre forhjul", TirePressureRearLeft.ToString(), myType.GetProperty("TirePressureRearLeft")),
                ...
                new CartSetupPropertyData("Med eller uden frontbar", IsWithFrontbar.ToString(), myType.GetProperty("IsWithFrontbar")),
